...
namespace Api.Controllers
{
    ...
    {
        public MedCardService Service { get; set; }

        public MedCardController(MedCardService service)
        {
            Service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Post(MedCardDTORequestPost entity)
        {
            var result = await Service.Post(entity);
            return Ok(result);
        }
        [HttpPut]
        public async Task<IActionResult> Update(int id, MedCardDTORequestUpdateTime entity)
        {
            if (!await Service.AnyAsync(id))
                return NotFound();
